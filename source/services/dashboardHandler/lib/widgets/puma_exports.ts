...
/**
 * @description cloudwatch widgets for puma workload
...
export const PumaLogWidgets: ILogWidget[] = [
   ...
   */
  {
    ...
    properties: {
      view: "table",
      title: "Puma Traffic by BytesSent",
      region: process.env.AWS_REGION as string,
   ...
   */
  {
    ...
    properties: {
      view: "table",
      title: "Puma Traffic by BytesReceived",
      region: process.env.AWS_REGION as string,
   ...
   */
  {
    ...
    properties: {
      view: "table",
      title: "Puma Traffic by ResponseTime(µs)",
      region: process.env.AWS_REGION as string,
      query: `SOURCE "${process.env.ACCESS_LOG_GROUP}" | %%filter%%\n| sort responseTime desc\n| display remoteIP, method, request, responseTime\n| limit 10`,
    },
  },
];
 ...
 */
export const PumaExplorerWidget: IExplorerWidget = {
  type: "explorer",
  x: 0,
  y: 30,
  width: 24,
...
/**
 * @description puma CPU widget
 */
export const PumaMetricWidgets: IMetricWidget[] = [
  {
    type: "metric",
    x: 0,
    y: 27,
